...
public class Triangle {
  ...
  public static void drawTriangle(double x, double y, double size) {
    ...
    StdDraw.line(x0, y1, x, y0);    // right vertical segment of the H
    StdDraw.line(x, y0, x1, y1);    // left  vertical segment of the H
...
drawTriangle(x, y, size);
  ...
  public static void drawReverseTriangle(double x, double y, double size) {
